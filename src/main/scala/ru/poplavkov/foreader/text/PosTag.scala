...
object PosTag {
  ...
  def fromPosTag(tag: String, token: String): Either[PunctuationMark, PartOfSpeech] = tag match {
    ...
    case "DT" | "EX" | "FW" | "LS" | "MD" | "PDT" | "POS" | "RP" | "SYM" | "TO" | "WDT" | "WP$" => Right(PartOfSpeech.Other)
    ...
    case _ => Right(PartOfSpeech.Other)
  }
